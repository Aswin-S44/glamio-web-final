...
import "./Footer.css";
import { ArrowRight, Sparkles, ChevronUp, Shield, Award, Star, Mail, MessageCircle } from "lucide-react";
      ...
      <div className="gf__container">
        <div className="gf__grid">
          ...
          <div className="gf__brand">
            ...
            <div className="gf__contact">
              <a href="mailto:nominoinnovations@gmail.com " className="gf__contact-item">
                <Mail size={14} />
                <span>nominoinnovations@gmail.com </span>
              </a>
              {/* <a href="https://wa.me/919447012345" target="_blank" rel="noreferrer" className="gf__contact-item">
        ...
        <div className="gf__bottom">
          <p className="gf__copy">
            &copy; 2026 Orucom Beauty Platform · All rights reserved ·
