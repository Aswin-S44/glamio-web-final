          ...
          <div className="su-split">
            ...
            >
              <div className="su-split-inner">
                ...
                <button
                  className="su-split-btn primary"
                  onClick={(e) => {
                    e.stopPropagation();
            ...
            <div className="su-split-card" onClick={() => setMode("salon")}>
              <div className="su-split-inner">
                ...
                <p>
                  ...
                  client management, and tools designed for high-end beauty
                  businesses.
                </p>
                <button
                  className="su-split-btn outline"
                  onClick={(e) => {
                    e.stopPropagation();
                    setMode("salon");
                  }}
        ...
        {mode === "salon" && (
          <div className="su-form-view">
            <div className="su-form-info">
              <h1>Salon Portal</h1>
              <p>
                Access powerful tools to manage appointments, staff, services,
                and grow your luxury salon brand.
              </p>
              ...
              <button className="su-back-btn" onClick={() => setMode(null)}>
                ← Back
              </button>
            </div>
            ...
            <div className="su-glass-wrap">
              <div className="su-glass-card">
                <h2>Salon Access</h2>
                <p>
                  Manage bookings, clients, and grow your luxury brand with
                  ease.
                </p>
