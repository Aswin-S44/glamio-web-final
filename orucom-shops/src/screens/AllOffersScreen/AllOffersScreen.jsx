...
const AllOffersScreen = ({ navigation }) => {
  ...
  const fetchOffers = useCallback(async () => {
    try {
      ...
      Alert.alert('Error', 'Could not fetch offers.');
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
    ...
    return (
      ...
      >
        <TouchableOpacity
          ...
          activeOpacity={0.9}
          onPress={() =>
            navigation.navigate('OfferDetailsScreen', { offer: item })
          }
        >
          ...
          <View style={styles.cardContent}>
            <View style={styles.cardHeader}>
              <View style={styles.categoryChip}>
                <Text style={styles.categoryText}>Special Offer</Text>
              </View>
              <TouchableOpacity
            ...
            <Text style={styles.serviceName} numberOfLines={1}>
              {item.serviceName || 'Unnamed Offer'}
            </Text>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.headerSafeArea}>
          ...
          <View style={styles.headerStats}>
            <Text style={styles.statsCount}>{offers.length}</Text>
            <Text style={styles.statsLabel}>Active Offers</Text>
          </View>
        </View>
      </View>
      ...
      <TouchableOpacity
        style={styles.fab}
        activeOpacity={0.8}
        onPress={() => navigation.navigate('AddOffersScreen')}
      >
      ...
      >
        <View style={styles.alertOverlay}>
          <View style={styles.alertBox}>
            ...
            <Text style={styles.alertTitle}>Delete Offer?</Text>
            <Text style={styles.alertMessage}>
              Are you sure you want to remove "{selectedOffer?.serviceName}"?
            </Text>
